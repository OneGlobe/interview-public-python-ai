...
const ConversationSidebar: React.FC<ConversationSidebarProps> = ({
  ...
  const { data: conversations, isLoading, isError, error } = useListConversations();
  ...
  return (
    <div className="chat-sidebar">
      ...
      <div className="padding-x-2">
        <h3 className="margin-y-1 font-size-sm text-bold text-uppercase">Recent Conversations</h3>
      </div>
